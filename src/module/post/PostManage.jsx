import { collection, deleteDoc, doc, getDocs, limit, onSnapshot, query, startAfter } from "firebase/firestore";
  ...
  return (
    <div>
      <DashboardHeading title="All posts" desc="Manage all posts">
        <Button kind="ghost" height="60px" to="/manage/add-post">
          Create post
        </Button>
      </DashboardHeading>
                ...
                <tr key={post.id}>
                  ...
                  <td>
                    <div className="flex items-center gap-x-3">
                      <img src={post.image} alt="" className="w-[66px] h-[55px] rounded object-cover" />
